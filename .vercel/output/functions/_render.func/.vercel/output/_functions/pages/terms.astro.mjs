...
const $$Terms$1 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section> <div class="mx-auto w-full lg:px-24 max-w-7xl md:px-12 items-center px-8 py-24"> <div> <div class="relative mx-auto max-w-[40rem] pt-20 pb-24"> <h1 class="text-black font-extrabold lg:text-5xl text-4xl tracking-tight">
Terms and conditions
</h1> <p class="mt-4 text-base leading-7 text-gray-500">
Last updated on January 01, 2023
</p> </div> </div> <div> <div class="mx-auto max-w-[40rem] prose-base prose text-gray-500 prose-h3:text-black prose-a:font-semibold prose-a:text-accent-300 hover:prose-a:text-black"> <p>
...
</p> <h3>Definitions</h3> <h3>DPO</h3> <p>
...
</p> <h3>Personal Information Collection</h3> <p>
...
</p> <h3>Personal Information Retention</h3> <p>
...
</p> <h3>Personal Data from Third Parties</h3> <p>
...
</p> <h3>Payment Vendors</h3> <p>
You can make payments via our website. Our vendors are listed below:
</p> <ul><li>Paypal</li></ul> <p>
Their privacy policy can be viewed <a href="https://www.paypal.com/webapps/mpp/ua/privacy-full">here</a> </p> <h3>Merger, acquisition or asset sale</h3> <p>
...
</p> <h3>Complaints</h3> <p>
If you believe that we have breached our obligations to you under this
          privacy policy or relevant privacy laws, please contact us at <a href="">email@example</a>
...
}, "C:/Users/Kehan/Documents/GitHub/wrapitmoving-vercel/src/components/infopages/Terms.astro", void 0);

const $$Terms = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navigation", $$Navigation, {})} ${renderComponent($$result2, "Terms", $$Terms$1, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "C:/Users/Kehan/Documents/GitHub/wrapitmoving-vercel/src/pages/terms.astro", void 0);

const $$file = "C:/Users/Kehan/Documents/GitHub/wrapitmoving-vercel/src/pages/terms.astro";
const $$url = "/terms";
